...
mix
    ...
    .purgeCss({
        // `wt-` classes only appear in markup built at runtime (the suggestion
        // rows), so PurgeCSS cannot see them in the source.
        whitelistPatterns: [/CodeMirror/, /cm/, /^theme-/, /^wt-/],
    })
